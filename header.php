...
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/scripts/cookie.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
            var visited = $.cookie("hfgscookie");
            if (visited == null) {
                $('.cookie_layer').show();
                $.cookie('hfgscookie', 'yes', { expires: 365, path: '/' });
            }
            $.cookie('hfgscookie', 'yes', { expires: 365, path: '/' });
        });
    </script>
...
<script type="text/javascript">
            ...
            var allowed = $.cookie("hsggdlallowed");
            if (allowed == null) {
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-20034801-3']);
...
<div id="wrapper">
	...
	<div id="header">
		...
		<div id="logo">
			<a href="<?php bloginfo('url'); ?>"><span>Harrogate Financial Solutions Limited</span></a>
		</div><!--logo -->

		<h3 class="header-tel">01423 873 757</h3>
		...
		<div class="legal">
			<p>Harrogate Financial Solutions Limited is authorised and regulated by the Financial Conduct Authority</p>
		</div>
			<img src="<?php bloginfo('template_url'); ?>/images/fp_logo.png" alt="Financial Planners Chartered Logo" />
